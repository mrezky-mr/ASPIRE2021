...
plt.title(r"$t = {a} \times tff$".format(a=t/(np.pi*orb)))
ax6.axis('equal')
ax6.scatter(coords[0][:Na],coords[1][:Na], s=4, label=r"$\sigma_c = {n} \ m$".format(n=s_cr1))
ax6.scatter(coords[0][Na:],coords[1][Na:], s=4, label=r"$\sigma_c = {n} \ m$".format(n=s_cr2))
...
ax7.scatter3D(coords[0][:Na],coords[1][:Na],coords[2][:Na], s=10, label=r"$\sigma_c = {n} m$".format(n=s_cr1))
ax7.scatter3D(coords[0][Na:],coords[1][Na:],coords[2][Na:], s=10, label=r"$\sigma_c = {n} m$".format(n=s_cr2))
ax7.set_xlabel('X (au)')
ax7.set_ylabel('Y (au)')
ax7.set_zlabel('Z (au)')
